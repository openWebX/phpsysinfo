...
class ParseMaster {
    ...
    public function exec ($sset ()vate $_escaped = [];  // escaped characters
...
pe ($string, $escapeChar) {
    ...
    private function _replac
 {
    ...
    // private
    priannot pass additional data to preg_replace_callback,
  ...
  ement ($arguments) {
    ...
    private function _  // encode escaped characters
    private function _escape
ferences ($match, $offset) {
...
e_name ($match, $offset) {
    ...
    private function _characters
    private function _unesca
e_encoded ($match, $offset) {
...
peBis () {
    ...
    private function _alEscape ($string) {
